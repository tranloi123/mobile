...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Thông số kỹ thuật</label>
          <textarea class="form-control" id="specifications" name="specifications">{{$product->specifications}}</textarea>
        ...
        <div class="form-group">
          <label for="size">Màu sắc (Cách nhau bởi dấu,)</label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Hình ảnh {{_('(Kích Thước Ảnh 300X300)')}}<span class="text-danger">*</span></label>
